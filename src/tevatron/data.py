...
class TrainDataset(Dataset):
    def __init__(
            ...
            dont_shuffle_negatives: bool = False
    ):
        ...
        self.dont_shuffle_negatives = dont_shuffle_negatives
    ...
    def __getitem__(self, item) -> Tuple[BatchEncoding, List[BatchEncoding]]:
        ...
        if len(group_negatives) < negative_size:
            ...
            if self.dont_shuffle_negatives:  # for batched negatives
                _offset = epoch * negative_size
