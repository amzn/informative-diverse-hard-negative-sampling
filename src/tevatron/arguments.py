...
class TevatronTrainingArguments(TrainingArguments):
    ...
    queries_batches_path: str = field(default=None, metadata={"help": "path to a partition of samples to batches."})

    dont_shuffle_negatives: bool = field(default=False, metadata={"help": "don't shuffle negatives."})
